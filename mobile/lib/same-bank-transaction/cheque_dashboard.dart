...
class Cheque_Dashboard extends StatefulWidget {
  const Cheque_Dashboard({Key? key}) : super(key: key);

  @override
  _Cheque_DashboardState createState() => _Cheque_DashboardState();
}
...
class _Cheque_DashboardState extends State<Cheque_Dashboard> {
              ...
              children: [
                ...
                Expanded(
                  child: Stack(children: <Widget>[
                    ...
                    ListView.builder(
                        itemCount: chequeMenuDatas.length,
                        itemBuilder: (context, index) => MenuCardCheque(
                              size: size,
                              itemIndex: index,
                              chequeMenuData: chequeMenuDatas[index],
                            ))
                  ]),
                )
              ],
