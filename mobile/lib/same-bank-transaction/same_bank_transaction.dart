...
class SameBankTransaction extends StatefulWidget {
  const SameBankTransaction({Key? key}) : super(key: key);

  @override
  _SameBankTransactionState createState() => _SameBankTransactionState();
}

class _SameBankTransactionState extends State<SameBankTransaction> {
