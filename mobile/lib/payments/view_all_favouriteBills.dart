...
class MyApp2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: ViewAllFavouriteBills(),
    );
  }
}

class ViewAllFavouriteBills extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _ViewAllFavouriteBillsState();
  }
}

class _ViewAllFavouriteBillsState extends State<ViewAllFavouriteBills> {
  Future<List<Favorite_Bill_Main>> listDataJSON() async {
    final url = Uri.parse("http://localhost:5000/bill/view");
  ...
  Future delete(String id) async {
    await http.delete(
      Uri.parse('http://localhost:5000/bill/delete/${id}'),
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      snapshot
                                          .data![currentIndex].serviceProvider,
