...
class BillPayDashBoard extends StatefulWidget {
  const BillPayDashBoard({Key? key}) : super(key: key);

  @override
  _BillPayDashBoardState createState() => _BillPayDashBoardState();
}
...
class _BillPayDashBoardState extends State<BillPayDashBoard> {
              ...
              children: [
                ...
                Expanded(
                  child: Stack(children: <Widget>[
                    ...
                    ListView.builder(
                        itemCount: billMenuDatas.length,
                        itemBuilder: (context, index) => MenuCard2(
                              size: size,
                              itemIndex: index,
                              billmenudata: billMenuDatas[index],
                            ))
                  ]),
                )
              ],
